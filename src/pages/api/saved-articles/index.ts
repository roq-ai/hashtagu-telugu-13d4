...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  async function getSavedArticles() {
    ...
    const response = await prisma.saved_article
      .withAuthorization({
        roqUserId,
      ...
      .findManyPaginated({
        ...convertQueryToPrismaUtil(query, 'saved_article'),
        take: limit,
        skip: offset,
        ...(order?.length && {
  ...
  async function createSavedArticle() {
    ...
    const data = await prisma.saved_article.create({
      data: body,
    });
