...
export function ArticleListPage(props: ArticleListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getArticles({
        relations: ['publisher', 'saved_article.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('publisher', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('saved_article', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'saved_article',
          header: 'Saved Article',
          accessorKey: 'saved_article',
          cell: ({ row: { original: record } }: any) => record?._count?.saved_article,
        }
      : null,
